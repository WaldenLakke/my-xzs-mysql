...
import com.yza.xzs.configuration.spring.property.CookieConfig;
import com.yza.xzs.configuration.spring.property.SystemConfig;
import com.yza.xzs.domain.enums.RoleEnum;
...
public class SecurityConfigurer {
    /**
     * 真正的配置类，继承WebSecurityConfigurerAdapter类，覆写Configurer(HttpSecurity)方法
     */
    @Configuration
    public static class FormLoginWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter{
        ...
        public void configure(HttpSecurity http) throws Exception {
            ...
            http
                    ...
                    .authorizeRequests()
                    .antMatchers(securityIgnoreUrls.toArray(new String[0])).permitAll()
